...
IFontDisp = Font
__all__ = [ 'OLE_ENABLEDEFAULTBOOL', 'Font', 'OLE_XSIZE_HIMETRIC',
           'Gray', 'IPictureDisp', 'FontEvents', 'FONTSIZE', 'Color',
           'OLE_HANDLE', 'IFontEventsDisp', 'IFont', 'IPicture',
           'OLE_CANCELBOOL', 'OLE_XSIZE_PIXELS', 'OLE_YSIZE_PIXELS',
           'LoadPictureConstants', 'FONTUNDERSCORE',
           'OLE_XPOS_CONTAINER', 'Default', 'OLE_COLOR',
           'OLE_YPOS_HIMETRIC', 'OLE_YPOS_PIXELS',
           'FONTSTRIKETHROUGH', 'VgaColor', 'OLE_XPOS_HIMETRIC',
           'FONTITALIC', 'Checked', 'StdPicture', 'FONTBOLD',
           'OLE_XPOS_PIXELS', 'FONTNAME', 'OLE_YPOS_CONTAINER',
           'Monochrome', 'Picture', 'OLE_XSIZE_CONTAINER',
           'OLE_TRISTATE', 'IFontDisp', 'OLE_OPTEXCLUSIVE',
           'OLE_YSIZE_CONTAINER', 'StdFont', 'OLE_YSIZE_HIMETRIC',
           'Unchecked']
